...
INITIAL_BONDED_LINK_POSITIONS = [
    ...
    (10, 5, 11, 6),  (11, 6, 11, 7), (11, 7,
                                      11, 8), (11, 8, 11, 9), (11, 9, 11, 10),
    (11, 10, 10, 11), (10, 11, 9, 11), (9, 11,
                                        8, 11), (8, 11, 7, 11), (7, 11, 6, 11),
...
while visualizer:
    ...
    for x in range(SPACE_SIZE):
        for y in range(SPACE_SIZE):
            ...
            mobility_factor = np.sqrt(
                MOBILITY_FACTOR[p['type']] * MOBILITY_FACTOR[n_p['type']])
